...
class PersonsPage(InternalPage):
    ...
    def try_get_expected_surname(self):
        WebDriverWait(self.driver, TIME_TO_WAIT).until(EC.text_to_be_present_in_element(self.EXPECTED_SURNAME, GIVEN_SURNAME))
    ...
    def try_get_expected_person_id(self):
        WebDriverWait(self.driver, TIME_TO_WAIT).until(EC.text_to_be_present_in_element(self.EXPECTED_PERSON_ID, GIVEN_PERSON_ID))
    ...
    def try_get_expected_num_os(self):
        WebDriverWait(self.driver, TIME_TO_WAIT).until(EC.text_to_be_present_in_element(self.EXPECTED_NUM_OS, GIVEN_NUM_OS))
    ...
    def try_get_expected_series_os(self):
        WebDriverWait(self.driver, TIME_TO_WAIT).until(EC.text_to_be_present_in_element(self.EXPECTED_SERIES_OS, GIVEN_SERIES_OS))
